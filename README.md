...
4. Deploy: **[docs/DEPLOY_CLOUDFLARE.md](docs/DEPLOY_CLOUDFLARE.md)** (recommended, since rothacademy.com is on Cloudflare) or [docs/DEPLOY_VERCEL.md](docs/DEPLOY_VERCEL.md). Private preview first, then go live.
