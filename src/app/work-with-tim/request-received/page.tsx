    ...
    <main>
      ...
      <div className="container">
        <div className="card" style={{ textAlign: "center" }}>
          <div className="seal" aria-hidden="true" style={{ display: "grid", placeItems: "center", width: 61, height: 61, borderRadius: "50%", background: "#e4ede6", fontSize: 30, margin: "0 auto 20px" }}>
            ✓
          </div>
          <p className="lead">
